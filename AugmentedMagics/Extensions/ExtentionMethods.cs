...
/***
 * Taken from https://github.com/Vek17/WrathMods-TabletopTweaks/tree/master/TabletopTweaks/Extensions
 * Copyright Vek17
 * Licensed as MIT
 ***/
namespace AugmentedMagics.Extensions {
    static class ExtentionMethods {
        ...
        public static void FixDomainSpell(this BlueprintAbility spell, int level, string spellListId) {
            var spellList = AugmentedMagics.Resources.GetBlueprint<BlueprintSpellList>(spellListId);
